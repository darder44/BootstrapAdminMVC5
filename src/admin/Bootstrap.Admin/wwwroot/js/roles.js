            ...
            events: {
                '#btn_assignUser': function (row) {
                    $.bc({
                        ...
                        callback: function (result) {
                            ...
                            $dialogUserHeader.text($.format('{0}-用户授權窗口', row.RoleName));
                ...
                '#btn_assignGroup': function (row) {
                    $.bc({
                        ...
                        callback: function (result) {
                            ...
                            $dialogGroupHeader.text($.format('{0}-部門授權窗口', row.RoleName));
                ...
                '#btn_assignMenu': function (row) {
                    $.bc({
                        ...
                        callback: function (result) {
                            $dialogMenuHeader.text($.format('{0}-選單授權窗口', row.RoleName));
