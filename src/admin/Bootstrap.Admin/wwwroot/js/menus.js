    ...
    $table.lgbTable({
                ...
                '#btn_assignRole': function (row) {
                    $.bc({
                        ...
                        callback: function (result) {
                            ...
                            $dialogRoleHeader.text($.format('{0}-角色授權窗口', row.Name));
        ...
        smartTable: {
            ...
            columns: [
                ...
                {
                    title: "所属應用", field: "Application", sortable: true, formatter: function (value, row, index) {
