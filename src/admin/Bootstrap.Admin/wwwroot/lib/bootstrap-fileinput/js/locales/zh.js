...
(function ($) {
    ...
    $.fn.fileinputLocales['zh'] = {
        ...
        msgFileRequired: '必须選擇一个文件上傳.',
        msgSizeTooSmall: '文件 "{name}" (<b>{size} KB</b>) 必须大于限定大小 <b>{minSize} KB</b>.',
        msgSizeTooLarge: '文件 "{name}" (<b>{size} KB</b>) 超过了允许大小 <b>{maxSize} KB</b>.',
        msgFilesTooLess: '你必须選擇最少 <b>{n}</b> {files} 来上傳. ',
        msgFilesTooMany: '選擇的上傳文件个數 <b>({n})</b> 超出最大文件的限制个數 <b>{m}</b>.',
        ...
        dropZoneClickTitle: '<br>(或點擊{files}按钮選擇文件)',
        fileActionSettings: {
            removeTitle: '删除文件',
            uploadTitle: '上傳文件',
            uploadRetryTitle: '重試',
