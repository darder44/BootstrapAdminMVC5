...
INSERT INTO [Dicts] ([Category], [Name], [Code], [Define]) VALUES ('網站設置', '前台首页', '~/Home/Index', 0);
...
-- 自動锁屏（秒）預設 30 秒
INSERT INTO [Dicts] ([Category], [Name], [Code], [Define]) VALUES ('網站設置', '自動锁屏時長', '30', 0);
INSERT INTO [Dicts] ([Category], [Name], [Code], [Define]) VALUES ('網站設置', '自動锁屏', '0', 0);
...
-- 系統登入首页設置
INSERT INTO [Dicts] ([Category], [Name], [Code], [Define]) VALUES ('系統首页', '高仿碼云', 'Login-Gitee', 1);
INSERT INTO [Dicts] ([Category], [Name], [Code], [Define]) VALUES ('系統首页', '蓝色清新', 'Login-Blue', 1);
INSERT INTO [Dicts] ([Category], [Name], [Code], [Define]) VALUES ('系統首页', '系統預設', 'Login', 1);
INSERT INTO Dicts (Category, Name, Code, Define) VALUES ('系統首页', '科技動感', 'Login-Tec', 1);
INSERT INTO Dicts (Category, Name, Code, Define) VALUES ('系統首页', 'Admin-LTE', 'Login-LTE', 1);
...
INSERT INTO [Navigations] ([ParentId], [Name], [Order], [Icon], [Url], [Category]) VALUES (0, '系統锁屏', 25, 'fa fa-television', '~/Account/Lock', '0');
...
INSERT INTO [Navigations] ([ParentId], [Name], [Order], [Icon], [Url], [Category], IsResource) VALUES (last_insert_rowid() - 1, '保存页脚設置', 20, 'fa fa-fa', 'saveFooter', '0', 2);
...
INSERT INTO [Roles] ([RoleName], [Description]) VALUES ('Default', '預設用户，可訪問前台页面');
...
Delete From [Dicts] Where Category = '應用首页' and Name = 'Demo';
INSERT INTO [Dicts] ([Category], [Name], [Code], [Define]) VALUES ('應用首页', 'Demo', 'http://localhost:49185', 0);

Delete From [Dicts] Where Category = '測試平台';
Insert into Dicts (Category, [Name], Code, Define) values ('測試平台', '網站標題', '前台演示系統', 1);
Insert into Dicts (Category, [Name], Code, Define) values ('測試平台', '網站页脚', '前台演示程式後台權限管理框架', 1);
